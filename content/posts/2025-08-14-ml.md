...
All depends how which use case we are addressing. However this blog assumed so far a standard feedforward network (Dense/Sequential in Keras) where each neuron talks to all neurons in the next layer.
